    ...
    <div className={gpuHeaderClass}>
      <h1 className="gpu-model-title">{gpu.model}</h1>
        <div className="image-container">
					<img className="front" src={`http://${window.location.hostname}:3001${gpu.images.front}`} alt="Graphics Card front" />
					<img className="core" src={`http://${window.location.hostname}:3001${gpu.images.core}`} alt="GPU Core" />
        </div>
